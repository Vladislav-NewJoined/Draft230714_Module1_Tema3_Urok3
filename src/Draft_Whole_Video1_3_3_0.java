...
public class Draft_Whole_Video1_3_3_0 {
    public static void main(String[] args) throws IOException {
        ...
        //  видео мин 39 50 - Как внутри sout написать кавычку с запятой и после старт (надо обратный слэш "\")
        //  видео мин 43 50 - В ссылках пробелов быть не может, только +
        //  видео мин 50 41 - Как переменную использовать вне метода , переменная term
        //  видео мин 57 56 - Напишем последний метод parseResult
